...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 bg-black text-white z-50 transition-all duration-300 ${
        isScrolled ? "shadow-md py-2" : "py-3"
      }`}
      style={{ height: "50px" }} // Fixed height for navbar
    >
        ...
        <div className="flex justify-between items-center h-full"> {/* Use h-full to center content */}
          <div
            ...
            style={{
              ...
              alignItems: "center",
              overflow: "hidden", // To prevent overflow when text changes
            }}
          >
            {displayedText}
          </div>
