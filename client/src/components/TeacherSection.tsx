      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <motion.div 
            ...
            className="flex-1"
          >
            <h3 className="text-3xl font-heading font-bold text-black mb-4">Mrs. Jane Smith</h3>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="inline-block bg-gray-200 text-gray-800 px-4 py-2 rounded-full text-sm">Networking</span>
              <span className="inline-block bg-gray-200 text-gray-800 px-4 py-2 rounded-full text-sm">Programming</span>
              <span className="inline-block bg-gray-200 text-gray-800 px-4 py-2 rounded-full text-sm">Systems Architecture</span>
            </div>
          </motion.div>
